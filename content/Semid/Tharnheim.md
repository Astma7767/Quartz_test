...
Większość występujących tu dolin to doliny **V-kształtne** o stromych, skalistych zboczach. Doliny **U-kształtne** stanowią rzadkość, a najbliższym przykładem doliny płaskodennej jest właśnie słynna **Przełęcz Bernabell**.

Kły Świata są jednym z nielicznych miejsc na całym kontynencie, gdzie występują naturalne złoża [[Kamien Rhunstall|kryształu Rhunstall]] — minerału o niezwykłej zdolności **gromadzenia magii**. 
Badacze postuluję, że tak znaczne nagromadzenie tego surowca nie pozostaje bez wpływu na miejscowy ekosystem: zarówno **pogoda**, jak i **fauna i flora** Kłów noszą wyraźne ślady oddziaływania magii.
...
niezależnie od tego, z której strony nadciąga burza, gdy napotyka ona Szczyt Świata, jej siła często **znacząco słabnie** lub nawet **zanika**.  
To zjawisko od dawna fascynuje zarówno lokalnych mieszkańców, jak i badaczy.
...
Fauna Kłów Świata jest równie fascynująca co flora. Wśród tutejszych stworzeń spotkać można zarówno dobrze znane gatunki, jak i istoty znane dotąd tylko z legend.
...
Specjalne oddziały smoczych jeźdźców **patrolują Garb Reolla**, polując na zdziczałe smoki i umacniając przewagę Tharnheimu.
...
W świadomości mieszkańców **honor**, **lojalność wobec klanu** oraz **szacunek dla Gór** i **smoków** są wartościami najwyższymi.

---

### Latające miasta i święte Gersy
...
Według najstarszych legend Arganthów, wszystkie **Gersy** (z języka Arganth: *góra*, ale też *twierdza*, *ostoja*) zostały **stworzone przez Reolla** — boga skał, szczytów i wytrwałości.  
...
**Bóg Klanów** czczony jest jako **Bóg Krwi i Relacji**.  
To on spaja klany i nadaje wagę **więzom krwi** i **honorowym relacjom**.  
...
**Matka Dolin**, zwana też **Płomieniem**, to stosunkowo młode bóstwo.  
Uosabia:
- **więź ludu ze smokami** (jako "płomień" krwi smoczej),  
- **naturalny temperament Arganthów**,  
- **życiodajny aspekt dolin**.

Jej kult jest **silnie wspierany przez obecne władze**, które starają się nim **zastąpić dawne, wojenne kulty**.
...
W powszechnych wierzeniach **Gersy** są do pewnego stopnia **żywe**.  
...
Mieszkańcy wierzą, że w takich wypadkach pojawia się **Duch Góry** — personifikacja danej Gersy — by **przekląć winowajcę**.  
...
- o **kamiennych znakach**, które pojawiają się przy domach heretyków,  
...
Król Tharnheimu zasiada na tronie z rodu **Tharnheim** i formalnie posiada **władzę absolutną**.  
...
W ważnych sprawach przeprowadza się **głosowanie**.  
**Głos Króla** ma wagę **równego głosu całego klanu** (czyli Klan Tharnheim zawsze de facto dysponuje **dwoma głosami**).  

W sprawach wojennych i ruchów **oddziałów smoczych jeźdźców**, decyzję podejmuje **wyłącznie Król** — te kompetencje nie podlegają głosowaniu.

---

#### Rotacyjne zadania klanów

Drugim wyznacznikiem **ważności klanu** są stanowiska **rotacyjne** — klan, który obejmuje dane stanowisko, sprawuje nad nim **pełną administracyjną władzę** przez 3 lata.  
Po tym okresie odbywa się głosowanie.  
Jeśli dany klan otrzyma **¾ głosów pozostałych klanów**, może utrzymać stanowisko na kolejną kadencję.

---

#### Aktualny podział stanowisk (od 13 lat niezmienny)

Od **13 lat** te same cztery klany **utrzymują te same stanowiska** — choć formalnie odbywają się głosowania, jest to **tajemnica poliszynela**, że wielkie klany **głosują na siebie nawzajem**, nie dopuszczając mniejszych do władzy.

---

##### Klan Wojny → *Klan Durnskar*  
**Przywódca:** *Tharic Durnskar*, **"Żelazny Tan"**  
→ Obsadzają administrację **oddziałów smoczych jeźdźców** (poza decyzjami strategicznymi Króla).  
→ Pilnują **pustkowi Wyspy Ognia** (obecnie więzienie dla niebezpiecznych magów).  
...
→ Kieruje **sądami** i **Białą Strażą** (funkcjonariusze w charakterystycznych białych pancerzach).  
...
→ Nadzorują **granice państwa**, organizują **święta** i **opiekę nad latającymi miastami**.  
...
→ Mają istotny wpływ na **kopalnie Rhunstallu**.

---

### Duchowni w Radzie

Choć formalnie duchowni podlegają **Klanowi Dziedzictwa**, w praktyce mają w Radzie własny silny głos.
